	...
	function isInAppBrowser() {
		var useragt = navigator.userAgent.toLowerCase();
		if(useragt.match(/kakaotalk/i) || useragt.match(/line/i) || useragt.match(/inapp|naver|snapchat|wirtschaftswoche|thunderbird|instagram|everytimeapp|whatsApp|electron|wadiz|aliapp|zumapp|iphone(.*)whale|android(.*)whale|kakaostory|band|twitter|DaumApps|DaumDevice\/mobile|FB_IAB|FB4A|FBAN|FBIOS|FBSS|SamsungBrowser\/[^1]/i)) {
			return true;
		}
		else {
			return false;
